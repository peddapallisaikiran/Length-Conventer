function lengthConventer(source, valNum){
    ...
    if(source == "inputInches"){
        ...
        inputFeet.value = (valNum*0.83333).toFixed(3);
        ...
        inputYards.value = (valNum*0.02777).toFixed(3);
    }
    if(source == "inputFeet"){
    ...
    if(source == "inputKilometers"){
        ...
        inputMiles.value = (valNum*0.62137).toFixed();
